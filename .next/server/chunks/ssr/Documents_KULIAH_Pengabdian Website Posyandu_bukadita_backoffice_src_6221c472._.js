module.exports = [
"[project]/Documents/KULIAH/Pengabdian Website Posyandu/bukadita_backoffice/src/lib/markdown-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function renderContent(text, enableMarkdown = true) {
    if (!text) return '';
    if (!enableMarkdown) {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (!res.data.poin_media || res.data.poin_media.length === 0) {
                    try {
                        const mediaRes = await apiFetch(`/api/v1/materials/poins/${encodeURIComponent(String(poinId))}/media`, {
                            method: "GET"
                        });
    ...
    const convertBlocksToHTML = ()=>{
        ...
        .map((block)=>{
            if (block.type === 'text' && block.content?.trim()) {
                ...
                const contentHtml = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$markdown$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["renderContent"])(block.content, true);
        ...
        if (html) {
            ...
            parts.forEach((part)=>{
                ...
                if (part.includes('data-block-type="media"') && part.includes('MEDIA_PLACEHOLDER_')) {
                    ...
                    content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$markdown$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["htmlToMarkdown"])(content);
                    if (content) {
                        blocks.push({
                            id: blockId,
                            type: 'text',
...
//# sourceMappingURL=Documents_KULIAH_Pengabdian%20Website%20Posyandu_bukadita_backoffice_src_6221c472._.js.map