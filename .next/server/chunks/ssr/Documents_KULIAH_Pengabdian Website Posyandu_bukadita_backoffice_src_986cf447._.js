...
function ModuleManagement() {
        ...
        try {
            ...
            if (quizRes.ok && quizRes.data?.items) {
                ...
                for (const material of materialsRes.data.items){
                    const subQuizRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["quizzesAPI"].list({
    ...
    const handleCreateSubmit = async (e)=>{
        ...
        setSubmitting(true);
        try {
            const apiRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["modulesAPI"].create(payload);
            if (apiRes.ok) {
                const listRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["modulesAPI"].list();
                if (listRes.ok) {
    ...
    const saveEdit = async (m)=>{
        ...
        setESubmitting(true);
        try {
            const apiRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["modulesAPI"].update(m.id, payload);
            if (apiRes.ok) {
                const listRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["modulesAPI"].list();
                if (listRes.ok) {
                    const items = parseList(listRes.data);
    ...
    const deleteModule = async (m)=>{
        ...
        if (result.isConfirmed) {
            try {
                const apiRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["modulesAPI"].remove(m.id);
                if (apiRes.ok) {
...
//# sourceMappingURL=Documents_KULIAH_Pengabdian%20Website%20Posyandu_bukadita_backoffice_src_986cf447._.js.map