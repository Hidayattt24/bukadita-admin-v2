...
function MaterialPoinManager({ materialId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadMaterial = async ()=>{
            setLoading(true);
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enhancedMaterialService"].getWithPoins(materialId);
                if (res.ok) {
    ...
    const handleAddPoin = async (e)=>{
        ...
        try {
            ...
            if (mediaFiles.length > 0) {
                ...
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["poinDetailService"].create(payload);
            }
            if (res.ok) {
                ...
                if (mediaFiles.length > 0 && res.data?.poin_media) {
                    ...
                    if (Object.keys(mediaMapping).length > 0) {
                        ...
                        try {
                            const updateRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["poinDetailService"].update(res.data.id, {
                ...
                const materialRes = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enhancedMaterialService"].getWithPoins(materialId);
                if (materialRes.ok) {
                    // Load complete media data for each poin for preview
    ...
    const handleUpdatePoin = async (e)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["poinDetailService"].update(editingPoin.id, payload);
            if (!res.ok) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
                    icon: 'error',
                    title: 'Error',
            ...
            if (mediaFiles.length > 0 && newMediaIds.length > 0) {
                ...
                if (Object.keys(mediaMapping).length > 0) {
                    ...
                    if (currentPoin) {
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["poinDetailService"].update(editingPoin.id, {
                            content_html: updatedHtml
                        });
                    }
                }
    ...
    const handleDeletePoin = async (poin)=>{
        ...
        if (result.isConfirmed) {
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$poin$2d$details$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["poinDetailService"].remove(poin.id);
                if (res.ok) {
...
//# sourceMappingURL=Documents_KULIAH_Pengabdian%20Website%20Posyandu_bukadita_backoffice_src_89416c11._.js.map