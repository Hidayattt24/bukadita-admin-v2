...
function ModuleItemsPage({ moduleId, resource }) {
    ...
    const onAdd = async ()=>{
        const { value: formValues, isConfirmed } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
            ...
            preConfirm: ()=>{
                ...
                if (!c || c.length < 10) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].showValidationMessage('Konten minimal 10 karakter');
                    return undefined;
                }
                return {
                    title: t,
    ...
    const onEdit = async (row)=>{
        ...
        const { value: formValues, isConfirmed } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
            title: `Edit ${title}`,
            html: `<input id="f-title" class="swal2-input" placeholder="Judul" value="${row.title.replace(/"/g, '&quot;')}"/>` + `<input id="f-desc" class="swal2-input" placeholder="Deskripsi (opsional)" value="${(row.description || '').replace(/"/g, '&quot;')}"/>` + `<label style="display:flex;align-items:center;gap:8px;justify-content:center;margin-top:6px"><input type="checkbox" id="f-pub" ${row.published ? 'checked' : ''}/> Terbitkan</label>`,
            focusConfirm: false,
            preConfirm: ()=>{
                const t = document.getElementById('f-title')?.value?.trim();
...
//# sourceMappingURL=Documents_KULIAH_Pengabdian%20Website%20Posyandu_bukadita_backoffice_70d8a3c4._.js.map