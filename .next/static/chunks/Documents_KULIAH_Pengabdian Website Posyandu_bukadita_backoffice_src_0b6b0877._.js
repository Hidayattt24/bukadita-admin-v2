...
function ModuleItemsPage(param) {
    ...
    const [aDescription, setADescription] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // kuis placeholder
    const [aQuestionCount, setAQuestionCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // kuis placeholder
        ...
        "ModuleItemsPage.useEffect": ()=>{
            const load = {
                "ModuleItemsPage.useEffect.load": async ()=>{
                    ...
                    // seed only for kuis or when entirely empty
                    if (resource === "kuis") {
                        const seed = [
                            {
                                id: crypto.randomUUID(),
                                title: "Kuis Gizi Dasar",
                                description: "Uji pemahaman gizi seimbang",
                            ...
                            },
                            {
                                id: crypto.randomUUID(),
                                title: "Kuis MPASI",
                                description: "Tes singkat tentang MPASI",
                                updated_at: new Date().toISOString(),
                                published: false,
                                questionCount: 8
                            }
    ...
    const submitAdd = async (e)=>{
        ...
        if (resource === 'materi') {
            ...
            const list = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$src$2f$lib$2f$api$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminMaterialsApi"].list({
                module_id: moduleId
            });
            if (list.ok) {
    ...
    const onEdit = async (row)=>{
        ...
        const { value: formValues, isConfirmed } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$KULIAH$2f$Pengabdian__Website__Posyandu$2f$bukadita_backoffice$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
            title: "Edit ".concat(title),
            html: '<input id="f-title" class="swal2-input" placeholder="Judul" value="'.concat(row.title.replace(/"/g, '&quot;'), '"/>') + '<input id="f-desc" class="swal2-input" placeholder="Deskripsi (opsional)" value="'.concat((row.description || '').replace(/"/g, '&quot;'), '"/>') + '<label style="display:flex;align-items:center;gap:8px;justify-content:center;margin-top:6px"><input type="checkbox" id="f-pub" '.concat(row.published ? 'checked' : '', "/> Terbitkan</label>"),
            focusConfirm: false,
            preConfirm: ()=>{
                var _value, _this, _value1, _this1, _this2;
                const t = (_this = document.getElementById('f-title')) === null || _this === void 0 ? void 0 : (_value = _this.value) === null || _value === void 0 ? void 0 : _value.trim();
...
_s(ModuleItemsPage, "Te/Fi5lhj9gleg/yc77gO8otyxU=");
_c = ModuleItemsPage;
var _c;
...
//# sourceMappingURL=Documents_KULIAH_Pengabdian%20Website%20Posyandu_bukadita_backoffice_src_0b6b0877._.js.map