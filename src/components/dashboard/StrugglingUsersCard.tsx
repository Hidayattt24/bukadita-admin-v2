...
export default function StrugglingUsersCard() {
  ...
  const percentage = totalUsers > 0 ? ((strugglingUsers / totalUsers) * 100).toFixed(1) : 0;
  ...
  return (
    <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl md:rounded-2xl p-4 md:p-6 border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 hover:shadow-lg">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-700">Kader Bermasalah</h3>
      ...
      <div className="mb-4">
        <div className="flex items-baseline gap-2 mb-2">
          <span className="text-4xl font-bold text-orange-600">{strugglingUsers}</span>
          <span className="text-sm text-slate-600">dari {totalUsers} kader</span>
        </div>
        <div className="flex items-center gap-2 text-xs text-slate-600">
          ...
          <span className="font-bold text-orange-600 min-w-[45px]">{percentage}%</span>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white py-2.5 rounded-lg font-semibold transition-all hover:shadow-lg group"
      >
