...
export default function UserTable({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 overflow-hidden">
      {loading ? (
        <div className="flex justify-center items-center py-16">
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 border-4 border-[#27548A] border-t-transparent rounded-full animate-spin"></div>
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => onView(user)}
                        className="p-2 text-[#27548A] hover:bg-blue-50 rounded-lg transition-all hover:scale-110"
                        title="Lihat Detail"
                      >
      ...
      {/* Modern Pagination */}
      {!loading && users.length > 0 && (
        <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 border-t-2 border-slate-100 gap-4 bg-slate-50">
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="px-4 py-2 border-2 border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-[#27548A] focus:border-[#27548A] bg-white font-medium text-slate-700 cursor-pointer transition-all"
            >
          ...
          {itemsPerPage !== "all" && pagination.totalPages > 1 && (
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 border-2 border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                Sebelumnya
              </button>
