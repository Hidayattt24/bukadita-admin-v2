...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-screen px-4 py-4 hidden md:flex md:flex-col bg-[#27548A] w-[300px] flex-shrink-0 border-r border-[#1e4068] fixed left-0 top-0",
          className
        )}
        animate={{
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-3 rounded-lg hover:bg-white/10 transition-colors",
        className
      )}
      {...props}
    >
